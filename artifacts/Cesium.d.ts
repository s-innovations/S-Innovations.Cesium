declare module "Cesium" {
    ...
    module Cesium {
        ...
        export class BillboardGraphics {
            ...
            //Methods
            clone(result): Cesium.BillboardGraphics
        ...
        export class BoundingSphere {
            ...
            //Methods
            static clone(sphere: Cesium.BoundingSphere, result): Cesium.BoundingSphere
            static computePlaneDistances(sphere: Cesium.BoundingSphere, position: Cesium.Cartesian3, direction: Cesium.Cartesian3, result): Cesium.Interval
            static distanceSquaredTo(sphere: Cesium.BoundingSphere, cartesian: Cesium.Cartesian3): number
            static equals(left, right): boolean
            static expand(sphere: Cesium.BoundingSphere, point: Cesium.Cartesian3, result): Cesium.BoundingSphere
            static fromBoundingSpheres(boundingSpheres: Cesium.BoundingSphere, result): Cesium.BoundingSphere
            static fromCornerPoints(corner, oppositeCorner, result): Cesium.BoundingSphere
            static fromEllipsoid(ellipsoid: Cesium.Ellipsoid, result): Cesium.BoundingSphere
            static fromPoints(positions: Cesium.Cartesian3, result): Cesium.BoundingSphere
            static fromRectangle2D(rectangle: Cesium.Rectangle, projection, result): Cesium.BoundingSphere
            static fromRectangle3D(rectangle: Cesium.Rectangle, ellipsoid, surfaceHeight, result): Cesium.BoundingSphere
            static fromRectangleWithHeights2D(rectangle: Cesium.Rectangle, projection, minimumHeight, maximumHeight, result): Cesium.BoundingSphere
            static fromVertices(positions: Cesium.Cartesian3, center, stride, result): Cesium.BoundingSphere
            ...
            static pack(value: Cesium.BoundingSphere, array: Array<number>, startingIndex): void
            static projectTo2D(sphere: Cesium.BoundingSphere, projection, result): Cesium.BoundingSphere
            static transform(sphere: Cesium.BoundingSphere, transform: Cesium.Matrix4, result): Cesium.BoundingSphere
            static transformWithoutScale(sphere: Cesium.BoundingSphere, transform: Cesium.Matrix4, result): Cesium.BoundingSphere
            static union(left: Cesium.BoundingSphere, right: Cesium.BoundingSphere, result): Cesium.BoundingSphere
            static unpack(array: Array<number>, startingIndex, result): void
            clone(result): Cesium.BoundingSphere
        ...
        export class BoxGraphics {
            ...
            //Methods
            clone(result): Cesium.BoxGraphics
        ...
        export class Camera {
            ...
            //Methods
            cameraToWorldCoordinates(cartesian: Cesium.Cartesian4, result): Cesium.Cartesian4
            cameraToWorldCoordinatesPoint(cartesian: Cesium.Cartesian3, result): Cesium.Cartesian3
            cameraToWorldCoordinatesVector(cartesian: Cesium.Cartesian3, result): Cesium.Cartesian3
            flyTo(options): void
            flyToBoundingSphere(boundingSphere: Cesium.BoundingSphere, options): void
            getMagnitude(): number
            getPickRay(windowPosition: Cesium.Cartesian2, result): Object
            getRectangleCameraCoordinates(rectangle: Cesium.Rectangle, result): Cesium.Cartesian3
            look(axis: Cesium.Cartesian3, angle): void
            lookAt(target: Cesium.Cartesian3, offset: Cesium.Cartesian3|Cesium.HeadingPitchRange): void
            lookAtTransform(transform: Cesium.Matrix4, offset): void
            lookDown(amount): void
            lookLeft(amount): void
            lookRight(amount): void
            lookUp(amount): void
            move(direction: Cesium.Cartesian3, amount): void
            ...
            moveUp(amount): void
            pickEllipsoid(windowPosition: Cesium.Cartesian2, ellipsoid, result): Cesium.Cartesian3
            rotate(axis: Cesium.Cartesian3, angle): void
            ...
            viewBoundingSphere(boundingSphere: Cesium.BoundingSphere, offset): void
            viewRectangle(rectangle: Cesium.Rectangle, ellipsoid): void
            worldToCameraCoordinates(cartesian: Cesium.Cartesian4, result): Cesium.Cartesian4
            worldToCameraCoordinatesPoint(cartesian: Cesium.Cartesian3, result): Cesium.Cartesian3
            worldToCameraCoordinatesVector(cartesian: Cesium.Cartesian3, result): Cesium.Cartesian3
            zoomIn(amount): void
            zoomOut(amount): void
        }
        ...
        export class Cartesian2 {
            ...
            //Methods
            clone(result): Cesium.Cartesian2
            equals(right): boolean
            equalsEpsilon(right, relativeEpsilon: number, absoluteEpsilon): boolean
            toString(): string
            ...
            static clone(cartesian: Cesium.Cartesian2, result): Cesium.Cartesian2
            ...
            static equals(left, right): boolean
            static equalsEpsilon(left, right, relativeEpsilon: number, absoluteEpsilon): boolean
            static fromArray(array: Array<number>, startingIndex, result): Cesium.Cartesian2
            static fromCartesian3(cartesian: Cesium.Cartesian3, result): Cesium.Cartesian2
            static fromCartesian4(cartesian: Cesium.Cartesian4, result): Cesium.Cartesian2
            static fromElements(x: number, y: number, result): Cesium.Cartesian2
            ...
            static pack(value: Cesium.Cartesian2, array: Array<number>, startingIndex): void
        ...
        export class Cartesian3 {
            ...
            //Methods
            clone(result): Cesium.Cartesian3
            equals(right): boolean
            equalsEpsilon(right, relativeEpsilon: number, absoluteEpsilon): boolean
            toString(): string
            ...
            static clone(cartesian: Cesium.Cartesian3, result): Cesium.Cartesian3
            ...
            static equals(left, right): boolean
            static equalsEpsilon(left, right, relativeEpsilon: number, absoluteEpsilon): boolean
            static fromArray(array: Array<number>, startingIndex, result): Cesium.Cartesian3
            static fromCartesian4(cartesian: Cesium.Cartesian4, result): Cesium.Cartesian3
            static fromDegrees(longitude: number, latitude: number, height, ellipsoid, result): Cesium.Cartesian3
            static fromDegreesArray(coordinates: Array<number>, ellipsoid, result): Cesium.Cartesian3
            static fromDegreesArrayHeights(coordinates: Array<number>, ellipsoid, result): Cesium.Cartesian3
            static fromElements(x: number, y: number, z: number, result): Cesium.Cartesian3
            static fromRadians(longitude: number, latitude: number, height, ellipsoid, result): Cesium.Cartesian3
            static fromRadiansArray(coordinates: Array<number>, ellipsoid, result): Cesium.Cartesian3
            static fromRadiansArrayHeights(coordinates: Array<number>, ellipsoid, result): Cesium.Cartesian3
            static fromSpherical(spherical: Cesium.Spherical, result): Cesium.Cartesian3
            ...
            static pack(value: Cesium.Cartesian3, array: Array<number>, startingIndex): void
        ...
        export class Cartesian4 {
            ...
            //Methods
            clone(result): Cesium.Cartesian4
            equals(right): boolean
            equalsEpsilon(right, relativeEpsilon: number, absoluteEpsilon): boolean
            toString(): string
            ...
            static clone(cartesian: Cesium.Cartesian4, result): Cesium.Cartesian4
            ...
            static equals(left, right): boolean
            static equalsEpsilon(left, right, relativeEpsilon: number, absoluteEpsilon): boolean
            static fromArray(array: Array<number>, startingIndex, result): Cesium.Cartesian4
            static fromColor(color: Cesium.Color, result): Cesium.Cartesian4
            static fromElements(x: number, y: number, z: number, w: number, result): Cesium.Cartesian4
            ...
            static pack(value: Cesium.Cartesian4, array: Array<number>, startingIndex): void
            static subtract(left: Cesium.Cartesian4, right: Cesium.Cartesian4, result: Cesium.Cartesian4): Cesium.Cartesian4
            static unpack(array: Array<number>, startingIndex, result): Cesium.Cartesian4
        }
        export class Cartographic {
            ...
            //Methods
            static clone(cartographic: Cesium.Cartographic, result): Cesium.Cartographic
            static equals(left, right): boolean
            static equalsEpsilon(left, right, epsilon: number): boolean
            static fromDegrees(longitude: number, latitude: number, height, result): Cesium.Cartographic
            static fromRadians(longitude: number, latitude: number, height, result): Cesium.Cartographic
            clone(result): Cesium.Cartographic
            equals(right): boolean
            equalsEpsilon(right, epsilon: number): boolean
            toString(): string
        }
        export class CesiumWidget {
            ...
            render(): void
            resize(): void
            showErrorPanel(title: string, message: string, error): void
        }
        export class Clock {
            constructor(options);
            //Members
        ...
        export class Color {
            ...
            static clone(color: Cesium.Color, result): Cesium.Color
            static equals(left: Cesium.Color, right: Cesium.Color): boolean
            static floatToByte(number: number): number
            static fromAlpha(color: Cesium.Color, alpha: number, result): Cesium.Color
            static fromBytes(red, green, blue, alpha, result): Cesium.Color
            static fromCartesian4(cartesian: Cesium.Cartesian4, result): Cesium.Color
            static fromCssColorString(color: string): Cesium.Color
            static fromHsl(hue, saturation, lightness, alpha): Cesium.Color
            static fromRandom(options, result): Cesium.Color
            static fromRgba(rgba: number): Cesium.Color
            static pack(value: Cesium.Color, array: Array<number>, startingIndex): void
            static unpack(array: Array<number>, startingIndex, result): void
            brighten(magnitude: number, result: Cesium.Color): Cesium.Color
            clone(result): Cesium.Color
            darken(magnitude: number, result: Cesium.Color): Cesium.Color
            equals(other: Cesium.Color): boolean
            equalsEpsilon(other: Cesium.Color, epsilon): boolean
            toBytes(result): Array<number>
            toCssColorString(): string
            toRgba(): number
            toString(): string
            withAlpha(alpha: number, result): Cesium.Color
        }
        ...
        export class CorridorGraphics {
            ...
            //Methods
            clone(result): Cesium.CorridorGraphics
            merge(source: Cesium.CorridorGraphics): void
        }
        export class Credit {
            constructor(text, imageUrl, link);
            //Members
            imageUrl: string
            link: string
            text: string
        ...
        export class CullingVolume {
            ...
            //Methods
            computeVisibility(boundingVolume: Object): Cesium.Intersect
        }
        ...
        export class CylinderGraphics {
            ...
            //Methods
            clone(result): Cesium.CylinderGraphics
        ...
        export class DataSourceClock {
            ...
            //Methods
            clone(result): Cesium.DataSourceClock
        ...
        export class DataSourceCollection {
            ...
            isDestroyed(): boolean
            remove(dataSource: Cesium.DataSource, destroy): boolean
        ...
        export class EllipseGraphics {
            ...
            //Methods
            clone(result): Cesium.EllipseGraphics
        ...
        export class Ellipsoid {
            ...
            //Methods
            static clone(ellipsoid: Cesium.Ellipsoid, result): Cesium.Ellipsoid
            static fromCartesian3(radii): Cesium.Ellipsoid
            static pack(value: Object, array: Array<number>, startingIndex): void
            static unpack(array: Array<number>, startingIndex, result): void
            cartesianArrayToCartographicArray(cartesians: Cesium.Cartesian3, result): Cesium.Cartographic
            cartesianToCartographic(cartesian: Cesium.Cartesian3, result): Cesium.Cartographic
            cartographicArrayToCartesianArray(cartographics: Cesium.Cartographic, result): Cesium.Cartesian3
            cartographicToCartesian(cartographic: Cesium.Cartographic, result): Cesium.Cartesian3
            clone(result): Cesium.Ellipsoid
            equals(right): boolean
            geocentricSurfaceNormal(cartesian: Cesium.Cartesian3, result): Cesium.Cartesian3
            geodeticSurfaceNormal(cartesian: Cesium.Cartesian3, result): Cesium.Cartesian3
            geodeticSurfaceNormalCartographic(cartographic: Cesium.Cartographic, result): Cesium.Cartesian3
            scaleToGeocentricSurface(cartesian: Cesium.Cartesian3, result): Cesium.Cartesian3
            scaleToGeodeticSurface(cartesian: Cesium.Cartesian3, result): Cesium.Cartesian3
            toString(): string
            transformPositionFromScaledSpace(position: Cesium.Cartesian3, result): Cesium.Cartesian3
            transformPositionToScaledSpace(position: Cesium.Cartesian3, result): Cesium.Cartesian3
        }
        export class EllipsoidGraphics {
            ...
            //Methods
            clone(result): Cesium.EllipsoidGraphics
        ...
        export class EntityCollection {
            ...
            getById(id: Object): Cesium.Entity
            getOrCreateEntity(id: Object): Cesium.Entity
        ...
        export class Event {
            ...
            //Methods
            addEventListener(listener: (() => void), scope): any
            raiseEvent(args: any): void
            removeEventListener(listener: (() => void), scope): boolean
        }
        export class FullscreenButton {
            constructor(container: Element|string, fullscreenElement);
            //Members
            container: Element
        ...
        export class Globe {
            ...
            isDestroyed(): boolean
            pick(ray: Cesium.Ray, scene: Cesium.Scene, result): Cesium.Cartesian3
        }
        ...
        export class HeadingPitchRange {
            ...
            //Methods
            static clone(hpr: Cesium.HeadingPitchRange, result): Cesium.HeadingPitchRange
        }
        export class HomeButton {
            constructor(container: Element|string, scene: Cesium.Scene, duration);
            //Members
            container: Element
        ...
        export class HomeButtonViewModel {
            constructor(scene: Cesium.Scene, duration);
            //Members
            command: Cesium.Command
        ...
        export class ImageryLayerCollection {
            ...
            //Methods
            add(layer: Cesium.ImageryLayer, index): void
            addImageryProvider(imageryProvider: Cesium.ImageryProvider, index): Cesium.ImageryLayer
            ...
            remove(layer: Cesium.ImageryLayer, destroy): boolean
            removeAll(destroy): void
        }
        export class ImageryLayerFeatureInfo {
            ...
            //Methods
            configureDescriptionFromProperties(properties: Object): void
            configureNameFromProperties(properties: Object): void
        }
        ...
        export class JulianDate {
            constructor(julianDayNumber: number, secondsOfDay: number, timeStandard);
            //Members
            ...
            static clone(julianDate: Cesium.JulianDate, result): Cesium.JulianDate
            ...
            static equals(left, right): boolean
            static equalsEpsilon(left, right, epsilon: number): boolean
            static fromDate(date: Date, result): Cesium.JulianDate
            static fromIso8601(iso8601String: string, result): Cesium.JulianDate
            ...
            static now(result): Cesium.JulianDate
            ...
            static toGregorianDate(julianDate: Cesium.JulianDate, result): Cesium.GregorianDate
            static toIso8601(julianDate: Cesium.JulianDate, precision): string
            static totalDays(julianDate: Cesium.JulianDate): number
            clone(result): Cesium.JulianDate
            equals(right): boolean
            equalsEpsilon(right, epsilon: number): boolean
            toString(): string
        }
        export class LabelGraphics {
            ...
            //Methods
            clone(result): Cesium.LabelGraphics
        ...
        export class MapProjection {
            ...
            //Methods
            project(cartographic: Cesium.Cartographic, result): Cesium.Cartesian3
            unproject(cartesian: Cesium.Cartesian3, result): Cesium.Cartographic
        }
        export class MaterialProperty {
            ...
            getValue(time: Cesium.JulianDate, result): Object
        }
        export class Matrix3 {
            ...
            static clone(matrix: Cesium.Matrix3, result): Cesium.Matrix3
            static computeEigenDecomposition(matrix: Cesium.Matrix3, result): Object
            static determinant(matrix: Cesium.Matrix3): number
            static equals(left, right): boolean
            static equalsEpsilon(left, right, epsilon: number): boolean
            static fromArray(array: Array<number>, startingIndex, result): Cesium.Matrix3
            static fromColumnMajorArray(values: Array<number>, result): Cesium.Matrix3
            static fromCrossProduct(the: Cesium.Cartesian3, result): Cesium.Matrix3
            static fromQuaternion(quaternion: Cesium.Quaternion): Cesium.Matrix3
            static fromRotationX(angle: number, result): Cesium.Matrix3
            static fromRotationY(angle: number, result): Cesium.Matrix3
            static fromRotationZ(angle: number, result): Cesium.Matrix3
            static fromRowMajorArray(values: Array<number>, result): Cesium.Matrix3
            static fromScale(scale: Cesium.Cartesian3, result): Cesium.Matrix3
            static fromUniformScale(scale: number, result): Cesium.Matrix3
            ...
            static pack(value: Cesium.Matrix3, array: Array<number>, startingIndex): void
            ...
            static toArray(matrix: Cesium.Matrix3, result): Array<number>
        ...
        export class Matrix4 {
            ...
            static clone(matrix: Cesium.Matrix4, result): Cesium.Matrix4
            ...
            static computeViewportTransformation(viewport, nearDepthRange, farDepthRange, result: Cesium.Matrix4): void
            static equals(left, right): boolean
            static equalsEpsilon(left, right, epsilon: number): boolean
            static fromArray(array: Array<number>, startingIndex, result): Cesium.Matrix4
            static fromCamera(camera: Cesium.Camera, result): void
            static fromColumnMajorArray(values: Array<number>, result): void
            static fromRotationTranslation(rotation: Cesium.Matrix3, translation, result): void
            static fromRowMajorArray(values: Array<number>, result): void
            static fromScale(scale: Cesium.Cartesian3, result): void
            static fromTranslation(translation: Cesium.Cartesian3, result): void
            static fromTranslationQuaternionRotationScale(translation: Cesium.Cartesian3, rotation: Cesium.Quaternion, scale: Cesium.Cartesian3, result): void
            static fromUniformScale(scale: number, result): void
            ...
            static pack(value: Cesium.Matrix4, array: Array<number>, startingIndex): void
            ...
            static toArray(matrix: Cesium.Matrix4, result): Array<number>
        ...
        export class ModelGraphics {
            ...
            //Methods
            clone(result): Cesium.ModelGraphics
        ...
        export class OrientedBoundingBox {
            ...
            //Methods
            static clone(box: Cesium.OrientedBoundingBox, result): Cesium.OrientedBoundingBox
            static equals(left: Cesium.OrientedBoundingBox, right: Cesium.OrientedBoundingBox): boolean
            static fromRectangle(rectangle: Cesium.Rectangle, minimumHeight, maximumHeight, ellipsoid, result): Cesium.OrientedBoundingBox
            static intersectPlane(box: Cesium.OrientedBoundingBox, plane: Cesium.Plane): Cesium.Intersect
            clone(result): Cesium.OrientedBoundingBox
            equals(right): boolean
            intersectPlane(plane: Cesium.Plane): Cesium.Intersect
        }
        export class PathGraphics {
            ...
            //Methods
            clone(result): Cesium.PathGraphics
        ...
        export class PerspectiveFrustum {
            ...
            //Methods
            clone(result): Cesium.PerspectiveFrustum
            ...
            getPixelSize(drawingBufferDimensions: Cesium.Cartesian2, distance, result): Cesium.Cartesian2
        }
        export class Plane {
            ...
            //Methods
            static fromCartesian4(coefficients: Cesium.Cartesian4, result): Cesium.Plane
            static fromPointNormal(point: Cesium.Cartesian3, normal: Cesium.Cartesian3, result): Cesium.Plane
        ...
        export class PointGraphics {
            ...
            //Methods
            clone(result): Cesium.PointGraphics
        ...
        export class PolygonGraphics {
            ...
            //Methods
            clone(result): Cesium.PolygonGraphics
        ...
        export class PolylineGraphics {
            ...
            //Methods
            clone(result): Cesium.PolylineGraphics
        ...
        export class PolylineVolumeGraphics {
            ...
            //Methods
            clone(result): Cesium.PolylineVolumeGraphics
        ...
        export class PositionProperty {
            ...
            //Methods
            getValue(time: Cesium.JulianDate, result): Cesium.Cartesian3
            getValueInReferenceFrame(time: Cesium.JulianDate, referenceFrame: Cesium.ReferenceFrame, result): Cesium.Cartesian3
        }
        export class PrimitiveCollection {
            ...
            //Methods
            add(primitive: Object): Object
            contains(primitive): boolean
            destroy(): void
            get(index: number): Object
            isDestroyed(): boolean
            lower(primitive): void
            lowerToBottom(primitive): void
            raise(primitive): void
            raiseToTop(primitive): void
        ...
        export class Quaternion {
            ...
            static clone(quaternion: Cesium.Quaternion, result): Cesium.Quaternion
            ...
            static convertPackedArrayForInterpolation(packedArray: Array<number>, startingIndex, lastIndex, result: Array<number>): void
            ...
            static fastSquad(q0: Cesium.Quaternion, q1: Cesium.Quaternion, s0: Cesium.Quaternion, s1: Cesium.Quaternion, t: number, result): Cesium.Quaternion
            static fromAxisAngle(axis: Cesium.Cartesian3, angle: number, result): Cesium.Quaternion
            static fromHeadingPitchRoll(heading: number, pitch: number, roll: number, result: Cesium.Quaternion): Cesium.Quaternion
            static fromRotationMatrix(matrix: Cesium.Matrix3, result): Cesium.Quaternion
            ...
            static pack(value: Cesium.Quaternion, array: Array<number>, startingIndex): void
            ...
            static unpack(array: Array<number>, startingIndex, result): void
            static unpackInterpolationResult(array: Array<number>, sourceArray: Array<number>, startingIndex, lastIndex, result): void
            clone(result): Cesium.Quaternion
            equals(right): boolean
            equalsEpsilon(right, epsilon: number): boolean
            toString(): string
        }
        export class Ray {
            ...
            //Methods
            static getPoint(t: number, result): void
        }
        export class Rectangle {
            ...
            //Methods
            static center(rectangle: Cesium.Rectangle, result): Cesium.Cartographic
            static clone(rectangle: Cesium.Rectangle, result): Cesium.Rectangle
            ...
            static equals(left, right): boolean
            static fromCartographicArray(cartographics: Cesium.Cartographic, result): Cesium.Rectangle
            static fromDegrees(west, south, east, north, result): Cesium.Rectangle
            static intersection(rectangle: Cesium.Rectangle, otherRectangle: Cesium.Rectangle, result): Cesium.Rectangle
            static northeast(rectangle: Cesium.Rectangle, result): Cesium.Cartographic
            static northwest(rectangle: Cesium.Rectangle, result): Cesium.Cartographic
            static pack(value: Cesium.Rectangle, array: Array<number>, startingIndex): void
            static southeast(rectangle: Cesium.Rectangle, result): Cesium.Cartographic
            static southwest(rectangle: Cesium.Rectangle, result): Cesium.Cartographic
            static subsample(rectangle: Cesium.Rectangle, ellipsoid, surfaceHeight, result): Cesium.Cartesian3
            static unpack(array: Array<number>, startingIndex, result): void
            static validate(rectangle: Cesium.Rectangle): void
            clone(result): Cesium.Rectangle
            equals(other): boolean
            equalsEpsilon(other, epsilon: number): boolean
        }
        export class RectangleGraphics {
            ...
            //Methods
            clone(result): Cesium.RectangleGraphics
        ...
        export class Scene {
            ...
            completeMorph(): void
            destroy(): void
            drillPick(windowPosition: Cesium.Cartesian2, limit): Array<Object>
            isDestroyed(): boolean
            ...
            pickPosition(windowPosition: Cesium.Cartesian2, result): Cesium.Cartesian3
        }
        ...
        export class ScreenSpaceEventHandler {
            ...
            //Methods
            destroy(): void
            getInputAction(type: number, modifier): void
            isDestroyed(): boolean
            removeInputAction(type: number, modifier): void
            setInputAction(action: (() => void), type: number, modifier): void
        }
        ...
        export class Spherical {
            ...
            //Methods
            static clone(spherical: Cesium.Spherical, result): void
            static equals(left: Cesium.Spherical, right: Cesium.Spherical): void
            static equalsEpsilon(left: Cesium.Spherical, right: Cesium.Spherical, epsilon): void
            static fromCartesian3(cartesian3: Cesium.Cartesian3, spherical): void
            static normalize(spherical: Cesium.Spherical, result): void
            clone(result): void
        ...
        export class TerrainMesh {
            constructor(center: Cesium.Cartesian3, vertices: Float32Array, indices: Uint16Array|Uint32Array, minimumHeight: number, maximumHeight: number, boundingSphere3D: Cesium.BoundingSphere, occludeePointInScaledSpace: Cesium.Cartesian3, vertexStride, orientedBoundingBox);
            //Members
        ...
        export class TerrainProvider {
            ...
            requestTileGeometry(x: number, y: number, level: number, throttleRequests): Cesium.TerrainData
        }
        ...
        export class TilingScheme {
            ...
            positionToTileXY(position: Cesium.Cartographic, level: number, result): Cesium.Cartesian2
            rectangleToNativeRectangle(rectangle: Cesium.Rectangle, result): Cesium.Rectangle
            tileXYToNativeRectangle(x: number, y: number, level: number, result): Cesium.Rectangle
            tileXYToRectangle(x: number, y: number, level: number, result): Cesium.Rectangle
        }
        export class TimeInterval {
            ...
            //Methods
            static clone(timeInterval, result): Cesium.TimeInterval
            ...
            static equalsEpsilon(left, right, epsilon: number, dataComparer): boolean
            static fromIso8601(options, result): Cesium.TimeInterval
            static intersect(left: Cesium.TimeInterval, right, result: Cesium.TimeInterval, mergeCallback): Cesium.TimeInterval
            static toIso8601(timeInterval: Cesium.TimeInterval, precision): string
            clone(result): Cesium.TimeInterval
            equals(right, dataComparer): boolean
            equalsEpsilon(right, epsilon: number, dataComparer): boolean
            toString(): string
        }
        export class TimeIntervalCollection {
            ...
            intersect(other: Cesium.TimeIntervalCollection, dataComparer, mergeCallback): void
            removeAll(): void
        ...
        export class Viewer {
            ...
            //Methods
            destroy(): void
            extend(mixin: any, options: Object): void
            flyTo(target: Cesium.Entity|Cesium.EntityCollection|Cesium.DataSource, options): Promise<boolean>
            forceResize(): void
            isDestroyed(): boolean
            render(): void
            resize(): void
            zoomTo(target: Cesium.Entity|Cesium.EntityCollection|Cesium.DataSource, offset): Promise<boolean>
        }
        export class WallGraphics {
            ...
            //Methods
            clone(result): Cesium.WallGraphics
